...
namespace NilremUserManagement.CustomSteps
{
    partial class PreviewUI : UserControl
    {
        ...
        internal void DisplayUser(User user)
        {
            ...
            chkConfidential.Checked = user.Permissions.CompanyConfidential;
            chkEmployeeData.Checked = user.Permissions.PersonalData;
            chkEmbezzle.Checked = user.Permissions.Embezzle;
        }
        ...
        private void PreviewUI_Resize(object sender, System.EventArgs e)
        {
            ...
            grpPermissions.Top = lblRole.Top-25;
            grpPermissions.Left = grpPermissions.Parent.ClientRectangle.Width - grpPermissions.Width - 10;
        }
    }
}
